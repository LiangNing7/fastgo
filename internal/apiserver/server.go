...
import (
	...
	"github.com/LiangNing7/fastgo/internal/apiserver/handler"
	"github.com/LiangNing7/fastgo/internal/apiserver/store"
	"github.com/LiangNing7/fastgo/internal/pkg/core"
...
func (s *Server) Run() error {
	...
	// 创建一个 os.Signal 类型的 channel，用于接受系统信号.
