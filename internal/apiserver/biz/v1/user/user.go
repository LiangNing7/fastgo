...
//go:generate mockgen -destination mock_user.go -package user github.com/LiangNing7/fastgo/internal/apiserver/biz/v1/user UserBiz
...
// ChangePassword 实现 UserBiz 接口中的 ChangePassword 接口.
